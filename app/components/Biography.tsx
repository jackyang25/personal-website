...
const Biography = () => {
  ...
  const bioParagraphs = [
    ">>> <span class='text-white'>Hey, welcome to my profile.</span>\n  <span class='text-white'>I attend New York University (Class of 2025), and I was born in Manhattan, New York City. I enjoy photography, traveling to new places, and meeting new people.</span>\n",
