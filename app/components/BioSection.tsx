...
const Biography = () => {
  ...
  const bioParagraphs = [
    ">>> <span class='text-white'>Hey 👋, welcome to my profile.</span>\n  <span class='text-white'>I'm a student at New York University and I was raised in Manhattan, NYC. I enjoy working out, traveling, and meeting new people.</span>\n",
